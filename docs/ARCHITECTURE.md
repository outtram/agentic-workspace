...
| **Command Palette** | `command_palette.py` | Navigable modal: commands, agents, skills (/ key). Uses deferred dismiss to prevent Enter bleed-through |
| **Filter Picker** | `filter_picker.py` | Navigable modal: q1-q4, overdue, today filters (: key). Uses deferred dismiss to prevent Enter bleed-through |
